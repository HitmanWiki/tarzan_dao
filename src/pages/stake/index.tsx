...
const StakePage: FC = () => {
  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      toast.success('Claim TARZAN success!');
    } catch (e) {
      setIsLoadingClaim(false);
      if (e?.error?.message) toast.error(e.error.message);
      else if (e?.message) toast.error(e.message);
        ...
        <div className="form-stake">
          ...
          <div className="wrapper-form-stake">
            ...
            <div className="body-form-stake">
              <div className="title">Stake TARZAN</div>
              ...
              <Form name="basic" form={form} onFinish={handleFinish} layout="vertical">
                ...
                <Form.Item
                  label={
                    ...
                    >
                      <div>dTARZAN Balance</div>
                      <div>{balanceWithdraw}</div>
                    </div>
                  }
                  name="dREALMBalance"
                  rules={[{ required: true, message: 'Please input your dTARZAN Balance!' }]}
                >
                  <div>
                    <Input
                      suffix={
          ...
          <div className="box-note">
            ...
            <div className="wrapper-note">
              ...
              <div className="body-note">
                ...
                <div>
                  Please note rewards are claimable whenever TARZAN is sent to the dTARZAN contract address. This means
