...
const SubmitProposalsPage: FC = () => {
  ...
  const options = [
    {
      label: 'Confirm 50% of the TARZAN once swapped will be sent to our dTARZAN contract and 50% sent to a burn wallet.',
      value: 'checkbox1',
    },
    {
        ...
        <div className="wrapper-form-submit">
          ...
          <div className="body-form-stake">
            ...
            <Form name="basic" form={form} initialValues={{ range: 3, time }} onFinish={handleFinish} layout="vertical">
              ...
              <Form.Item
                label="Provide a short description of the Project, and why it is suitable for investment from the TARZAN."
              ...
              <Form.Item
                label="Provide the rate at which the investee token will be swapped for TARZAN. For example X% per day, week or month, for x number of months."
                name="rate"
                rules={[{ required: true, message: 'This field is required!' }]}
              >
